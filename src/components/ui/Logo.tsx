      ...
      >
        <defs>
          <linearGradient id="logo-grad" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="1" stopColor="#3DD6FA" />
          </linearGradient>
        </defs>
        {/* Outer frame */}
        <rect x="1" y="1" width="30" height="30" rx="7" stroke="url(#logo-grad)" strokeWidth="1.25" />
        {/* U */}
        <path
        ...
        {/* Node dots */}
        <circle cx="20.5" cy="13.75" r="1" fill="#3DD6FA" />
        <circle cx="13" cy="9" r="1" fill="#3DD6FA" />
      </svg>
      {withWordmark && (
